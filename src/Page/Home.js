    ...
    <div>
      ...
      <div className="z-0 ">
        <div className="flex bg-head1 bg-cover h-screen text-center justify-center relative">
          ...
          <div className=" font-prompt text-white absolute top-44 right-96  text-6xl">
            บ้านเดี่ยวหรู หลากหลายสไตล์
          </div>
          <div className=" font-prompt text-right text-white absolute top-64 right-96  text-2xl">
            มาพร้อมกับโครงการใหม่
            Scadinavian Touch บนทำเลดีเยี่ยม
            สัมผัสกับธรรมชาติ
          </div>
          <Link to="/House">
            <button className=" font-prompt absolute top-80 right-96 bg-gray-300 bg-opacity-75 hover:bg-gray-200 text-black  py-2 px-4  rounded w-48 text-2xl">
              จองเลย
            </button>
          </Link>
        </div>

        <div className=" flex bg-head2 bg-cover bg-right-bottom h-screen relative text-center justify-center ">
          <div className=" font-prompt text-white absolute top-44 right-96  text-6xl ">
            บ้านทาวเฮาส์สุดแจ่ม
          </div>
          <div className=" font-prompt text-right text-white absolute top-64 right-96  text-2xl">
        ...
        <Link to="/Condo">
          <button className=" font-prompt absolute top-80 right-96 bg-gray-300 bg-opacity-75 hover:bg-gray-200 text-black font-bold py-2 px-4  rounded w-48 text-2xl">
            จองเลย
          </button>
        </Link>
        </div>
